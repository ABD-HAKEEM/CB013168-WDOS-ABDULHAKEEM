document.addEventListener('alpine:init', () => {
    Alpine.store('animals', {
        ...
        animal_section_three: {
            ...
            image16: '/Images/Sambar deer.JPG',
            title16: 'Sambar deer',
            body16: "Sambars are a large species of deer that lives in southern Asia. They have distinctly different coats and body types across their range. These differences are so drastic that scientists recognize a number of different subspecies. Sadly, the population as a whole is in decline because of human activity. Read on to learn about the sambar.",
