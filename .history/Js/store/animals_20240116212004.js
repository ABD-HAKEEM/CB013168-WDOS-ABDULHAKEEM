document.addEventListener('alpine:init', () => {
    Alpine.store('animals', {
        ...
        animal_section_three: {
            ...
            image8: '/Images/Boar.jpg',
            title8: 'Boar',
            body8: "Wild boar are the pig that is thought to have been domesticated over a period of thousands of years, to give us our familiar domestic pig. They can be a fearsome animal to encounter, as they have a powerful body-shape, they snort very loudly, and they often have sharp tusks.",
      
            image8: '/Images/Golden jackal.jpg',
            title8: 'Golden jackal',
            body8: "The Golden jackal has long, pointed ears and long hair. The coat of the animal is rather coarse and not very long. The tail is fluffy and long. Being the largest species of jackal, this animal, however, has lighter tread, shorter tail, more slender build and a narrower, more pointed muzzle, compared to other jackal species.",
