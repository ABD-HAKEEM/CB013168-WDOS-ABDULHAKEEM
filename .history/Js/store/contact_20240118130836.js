document.addEventListener('alpine:init', () => {
    Alpine.store('contact', {
        ...
        contact_section_two: {
            title: "Sri Lanka's Wild Life contacts",
        ...
        contact_section_three: {
            ...
            body3: "The Indian porcupine is an ‘Old World’ porcupine and one of the world's largest porcupines. This rodent has rather long quills of up to 16 inches. Unlike the 'New World' porcupines, this porcupine is a ground-dwelling and burrowing contact. The amazingly strong front feet allow the contact excavate substantial burrows.",
            ...
            title6: 'Leopard',
            body6: "This middle-sized wild cat has a slim and long body with short, sturdy legs and a long tail, helping the contact to keep balance when in the trees. The head is broad and the skull is large, having strong and powerful jaw muscles. The ears are small and round. The eyebrows exhibit long hairs, protecting the eyes of the contact as it moves through dense vegetation.",
            ...
            title11: 'Boar',
            body11: "Wild boar are the pig that is thought to have been domesticated over a period of thousands of years, to give us our familiar domestic pig. They can be a fearsome contact to encounter, as they have a powerful body-shape, they snort very loudly, and they often have sharp tusks.",
      
            image12: '/Images/Golden jackal.jpg',
            title12: 'Golden jackal',
            body12: "The Golden jackal has long, pointed ears and long hair. The coat of the contact is rather coarse and not very long. The tail is fluffy and long. Being the largest species of jackal, this contact, however, has lighter tread, shorter tail, more slender build and a narrower, more pointed muzzle, compared to other jackal species.",
