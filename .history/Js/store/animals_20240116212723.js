document.addEventListener('alpine:init', () => {
    Alpine.store('animals', {
        ...
        animal_section_three: {
            ...
            image16: '/Images/Serendib Scops Owl.jpg',
            title16: 'Serendib Scops Owl',
            body16: "A diminutive rufescent owl, characterized by yellow-orange eyes and modest, light speckling on its underparts. While lacking genuine ear tufts, it can exhibit 'false' ones when vigilant. Typically inhabits the expansive humid rainforests within the lowlands of the Wet Zone in Sri Lanka. It prefers roosting individually or in pairs within the understory but may also be found in the higher branches of trees during the night.",
