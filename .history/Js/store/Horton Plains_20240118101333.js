document.addEventListener('alpine:init', () => {
    Alpine.store('Horton_Plains', {
        ...
        {
            image: '/Images/Horton_Plains/Horton_Plains-National-Park-header.jpg',
            title: "Horton_Plains National Park"
        },
        Horton_Plains_section_two: {
            title: "Horton_Plains (විල්පත්තු ජාතික වනෝද්‍යානය) National",
            body: "Horton_Plains National Park is a pristine wildlife sanctuary located in the northwest of Sri Lanka. Renowned for its diverse ecosystems and picturesque landscapes, Horton_Plains is the largest national park in the country, spanning over 1,300 square kilometers",


        },
        Horton_Plains_section_three: {
            title: "Historical Odyssey of Horton_Plains's Wilderness",
