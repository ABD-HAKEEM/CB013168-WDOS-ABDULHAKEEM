document.addEventListener('alpine:init', () => {
    Alpine.store('animals', {
        ...
        animal_section_three: {
            ...
            image8: '/Images/Ruddy mongoose.jpg',
            title8: 'Ruddy mongoose',
            body8: "The ruddy mongoose's fur is brownish and coarse, long in hindquarters, but short in other parts of the body. Its head to body length is 40–45 cm (16–18 in) with a 36 cm (14 in) long tail. Males are larger and heavier than females with a weight of 2.2 kg (4.9 lb); females weigh about 1.2 kg (2.6 lb). Tail constitute about 75-90 % of body length.",
