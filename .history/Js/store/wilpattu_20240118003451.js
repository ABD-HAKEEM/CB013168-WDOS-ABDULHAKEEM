document.addEventListener('alpine:init', () => {
    Alpine.store('wilpattu', {
        ...
        wilpattu_section_two: {
            title: "Wilpattu (විල්පත්තු ජාතික වනෝද්‍යානය) Nationalbody: "wilpattu National Park, situated in the southeastern part of Sri Lanka, is renowned for its diverse wildlife and stunning natural landscapes. Spanning over 979 square kilometers, the park is home to a variety of ecosystems, including scrub jungles, grasslands, and coastal lagoons.",
            sub_title:'Discover',
