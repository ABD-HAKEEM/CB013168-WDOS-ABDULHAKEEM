document.addEventListener('alpine:init', () => {
    Alpine.store('lep', {
        ...
        leo_section_five: {
            ...
            title1:'Panthera pardus in Yala National Park',
            body1:'Located in the southeastern part of Sri Lanka, Yala National Park is renowned for its diverse wildlife, and it is one of the best places to spot leopards in the country. The park features a mix of ecosystems, including dense forests, grasslands, and coastal areas, providing an ideal habitat for leopards. Yala is home to a significant leopard population, and visitors often have the opportunity to witness these elusive big cats during safari tours.',
        },
