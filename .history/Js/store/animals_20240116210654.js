document.addEventListener('alpine:init', () => {
    Alpine.store('animals', {
        ...
        animal_section_three: {
            ...
            image3: '/Images/Asian elephant.jpg',
            title3: 'Asian Elephant',
            body3: "Toque macaques, exclusive to Sri Lanka, an island nation in South Asia situated in the Indian Ocean, are acknowledged as Old World monkeys. They inhabit diverse forest types spanning various altitudes, reaching up to 6,890 ft (2,100 m) depending on the subspecies. On average, their habitats are situated at an elevation of 3,281 ft (1,000 m).",
