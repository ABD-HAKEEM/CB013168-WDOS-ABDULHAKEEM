document.addEventListener('alpine:init', () => {
    Alpine.store('wilpattu', {
        ...
        {
            image: '/Images/wilpattu 2.jpg',
            title: "wilpattu National Park"
        },
        wilpattu_section_two: {
            title: "wilpattu (යාල) National Park",
            body: "wilpattu National Park, situated in the southeastern part of Sri Lanka, is renowned for its diverse wildlife and stunning natural landscapes. Spanning over 979 square kilometers, the park is home to a variety of ecosystems, including scrub jungles, grasslands, and coastal lagoons.",
            sub_title:'Discover',

        },
        wilpattu_section_three: {
            title: "The historical backdrop of wilpattu National Park",
            body: "wilpattu National Park, situated in Sri Lanka, has a storied history dating back to ancient times, serving as a hunting ground for early rulers. Its transformation into a conservation area began during the British colonial era, marked by its designation as a game sanctuary in 1900 and later as a national park in 1938. Originally utilized for hunting by the British elite, the park gradually shifted towards conservation. Post-independence, wilpattu became a crucial wildlife sanctuary, especially renowned for its high leopard population. Today, it stands as a testament to Sri Lanka's commitment to preserving its natural heritage and fostering biodiversity.",
            image: '/Images/wilpattu/wilpattuCollage.jpg',
        },
        wilpattu_section_four_card1:{
            title: "Mammals",
            body: "wilpattu National Park in Sri Lanka is a top wildlife destination with a diverse range of mammals, including leopards, Asian elephants, sloth bears, deer species like sambar and spotted deer, wild boars, water buffalo, and Indian grey mongooses. Visitors can witness these predators in their natural habitats and enjoy safari adventures.",
            image:'/Images/wilpattu page Card 1.jpg',
        },
